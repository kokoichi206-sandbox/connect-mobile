...
/**
 * @generated from message say.v1.SayRequest
 */
export class SayRequest extends Message<SayRequest> {
  ...
  static readonly typeName = "say.v1.SayRequest";
...
/**
 * @generated from message say.v1.SayResponse
 */
export class SayResponse extends Message<SayResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "say.v1.SayResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sentence", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
